function [Ax, Ay, Az] = get_variable_load_params()
%%%
...
[Ay(1,:), Az(1,:)] = magic_formula_corner(4.448*50,  0, 1, 50 );
[Ay(2,:), Az(2,:)] = magic_formula_corner(4.448*100, 0, 1, 100);
[Ay(3,:), Az(3,:)] = magic_formula_corner(4.448*150, 0, 1, 150);
[Ay(4,:), Az(4,:)] = magic_formula_corner(4.448*200, 0, 1, 200);
[Ay(5,:), Az(5,:)] = magic_formula_corner(4.448*250, 0, 1, 250);
end